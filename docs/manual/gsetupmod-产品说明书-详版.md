...
适用于 BUILD 153（0.1.0.153）｜目标读者：进阶用户、固件工程师
...
![表单区（毛玻璃透出壁纸）](images/form-rows.png)
...
![ONE_OF 胶囊分段](images/edit-oneof.png)

![ONE_OF 选项列表弹层](images/edit-oneof-list.png)
...
![设置对话框（暗色）](images/settings-dlg.png)
...
![深色档（默认）](images/mm-boot_main.png)

![浅色档](images/light-main.png)

浅色档表单与设置对话框：

![浅色档表单区](images/light-form.png)

![浅色档设置对话框](images/light-settings.png)
